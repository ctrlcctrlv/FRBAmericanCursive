...
colrglyphs-ufo:
	...
	find $(FONTFAMILY)-SOURCE.ufo/glyphs/ -iname "*.glif" | tac | parallel -I^ --bar '\''./scripts/make_arrows_for_glyph.py ^ build/$(FONTFAMILY)-{1}.ufo/COLR_glyphs/`basename -s.glif ^`_arrows.glif {2}'\''
	'
